"""
In-memory demo data. NO DATABASE CONNECTED — demo build.
Har content field bilingual hai: {"hi": "...", "en": "..."}

Jab client kharide, is file ko SQLAlchemy models se replace kar dena.
Route signatures wahi rahenge.
"""
...
SPACES = [
    {
        ...
        "photos": [
            "https://picsum.photos/seed/sv-lawn-1/1200/800",
            "https://picsum.photos/seed/sv-lawn-2/1200/800",
            "https://picsum.photos/seed/sv-lawn-3/1200/800",
            "https://picsum.photos/seed/sv-lawn-4/1200/800",
        ],
    },
    {
        "id": "banquet",
        ...
        "photos": [
            "https://picsum.photos/seed/sv-banquet-1/1200/800",
            "https://picsum.photos/seed/sv-banquet-2/1200/800",
            "https://picsum.photos/seed/sv-banquet-3/1200/800",
            "https://picsum.photos/seed/sv-banquet-4/1200/800",
        ],
    },
    {
        "id": "engagement",
        ...
        "photos": [
            "https://picsum.photos/seed/sv-eng-1/1200/800",
            "https://picsum.photos/seed/sv-eng-2/1200/800",
            "https://picsum.photos/seed/sv-eng-3/1200/800",
            "https://picsum.photos/seed/sv-eng-4/1200/800",
        ],
    },
]

# Per-plate calculator ke rates
PACKAGES = [
    {
        "id": "silver",
    ...
    },
    {
        ...
        "extra": {
            "hi": ["आतिशबाज़ी", "फोटोग्राफी टीम"],
            "en": ["Fireworks", "Photography team"],
        },
    },
]

COMPARISON_ROWS = [
    {"key": "rental", "label": {"hi": "लॉन किराया", "en": "Venue rental"},
     "values": {"silver": {"hi": "₹85,000", "en": "₹85,000"}, "gold": {"hi": "₹1,25,000", "en": "₹1,25,000"}, "platinum": {"hi": "₹1,75,000", "en": "₹1,75,000"}}},
    {"key": "hours", "label": {"hi": "समय", "en": "Hours"},
     "values": {"silver": {"hi": "8 घंटे", "en": "8 hours"}, "gold": {"hi": "12 घंटे", "en": "12 hours"}, "platinum": {"hi": "24 घंटे", "en": "24 hours"}}},
    {"key": "plate_veg", "label": {"hi": "प्रति प्लेट — शाकाहारी", "en": "Per plate — veg"},
     "values": {"silver": {"hi": "₹750", "en": "₹750"}, "gold": {"hi": "₹1,050", "en": "₹1,050"}, "platinum": {"hi": "₹1,450", "en": "₹1,450"}}},
    {"key": "plate_nonveg", "label": {"hi": "प्रति प्लेट — मांसाहारी", "en": "Per plate — non-veg"},
     "values": {"silver": {"hi": "₹950", "en": "₹950"}, "gold": {"hi": "₹1,350", "en": "₹1,350"}, "platinum": {"hi": "₹1,850", "en": "₹1,850"}}},
    {"key": "min", "label": {"hi": "न्यूनतम मेहमान", "en": "Minimum guests"},
     "values": {"silver": {"hi": "200", "en": "200"}, "gold": {"hi": "300", "en": "300"}, "platinum": {"hi": "400", "en": "400"}}},
    {"key": "decor", "label": {"hi": "सजावट", "en": "Decor"},
     "values": {"silver": {"hi": "बेसिक स्टेज", "en": "Basic stage"}, "gold": {"hi": "फूलों का मंडप + स्टेज", "en": "Floral mandap + stage"}, "platinum": {"hi": "थीम सजावट + लाइटिंग", "en": "Theme decor + lighting"}}},
    {"key": "dj", "label": {"hi": "डीजे / साउंड", "en": "DJ / sound"},
     "values": {"silver": {"hi": "नहीं", "en": "No"}, "gold": {"hi": "शामिल", "en": "Included"}, "platinum": {"hi": "डीजे + लाइव बैंड", "en": "DJ + live band"}}},
    {"key": "rooms", "label": {"hi": "कमरे", "en": "Rooms"},
     "values": {"silver": {"hi": "नहीं", "en": "No"}, "gold": {"hi": "4 एसी कमरे", "en": "4 AC rooms"}, "platinum": {"hi": "सभी 12 कमरे", "en": "All 12 rooms"}}},
    {"key": "counters", "label": {"hi": "लाइव काउंटर", "en": "Live counters"},
     "values": {"silver": {"hi": "नहीं", "en": "No"}, "gold": {"hi": "2", "en": "2"}, "platinum": {"hi": "5 + पान/चाट", "en": "5 + paan/chaat"}}},
    {"key": "parking", "label": {"hi": "पार्किंग", "en": "Parking"},
     "values": {"silver": {"hi": "2 स्टाफ", "en": "2 staff"}, "gold": {"hi": "5 स्टाफ", "en": "5 staff"}, "platinum": {"hi": "वैलेट", "en": "Valet"}}},
    {"key": "manager", "label": {"hi": "इवेंट मैनेजर", "en": "Event manager"},
     "values": {"silver": {"hi": "नहीं", "en": "No"}, "gold": {"hi": "साझा", "en": "Shared"}, "platinum": {"hi": "समर्पित", "en": "Dedicated"}}},
]

GALLERY = [
    {"id": 1, "cat": "haldi", "src": "https://picsum.photos/seed/sv-haldi-1/900/1200", "alt": {"hi": "हल्दी की रस्म", "en": "Haldi ceremony"}},
    {"id": 2, "cat": "haldi", "src": "https://picsum.photos/seed/sv-haldi-2/1200/900", "alt": {"hi": "हल्दी सजावट", "en": "Haldi decor"}},
    {"id": 3, "cat": "haldi", "src": "https://picsum.photos/seed/sv-haldi-3/1200/900", "alt": {"hi": "हल्दी में परिवार", "en": "Family at haldi"}},
    {"id": 4, "cat": "sangeet", "src": "https://picsum.photos/seed/sv-sangeet-1/1200/900", "alt": {"hi": "संगीत की रात", "en": "Sangeet night"}},
    {"id": 5, "cat": "sangeet", "src": "https://picsum.photos/seed/sv-sangeet-2/900/1200", "alt": {"hi": "संगीत स्टेज", "en": "Sangeet stage"}},
    {"id": 6, "cat": "sangeet", "src": "https://picsum.photos/seed/sv-sangeet-3/1200/900", "alt": {"hi": "डीजे सेटअप", "en": "DJ setup"}},
    {"id": 7, "cat": "wedding", "src": "https://picsum.photos/seed/sv-wed-1/1200/900", "alt": {"hi": "फेरे", "en": "Pheras"}},
    {"id": 8, "cat": "wedding", "src": "https://picsum.photos/seed/sv-wed-2/900/1200", "alt": {"hi": "मंडप", "en": "Mandap"}},
    {"id": 9, "cat": "wedding", "src": "https://picsum.photos/seed/sv-wed-3/1200/900", "alt": {"hi": "बारात", "en": "Baraat"}},
    {"id": 10, "cat": "reception", "src": "https://picsum.photos/seed/sv-rec-1/1200/900", "alt": {"hi": "रिसेप्शन स्टेज", "en": "Reception stage"}},
    {"id": 11, "cat": "reception", "src": "https://picsum.photos/seed/sv-rec-2/900/1200", "alt": {"hi": "रात की लाइटिंग", "en": "Night lighting"}},
    {"id": 12, "cat": "reception", "src": "https://picsum.photos/seed/sv-rec-3/1200/900", "alt": {"hi": "डिनर काउंटर", "en": "Dinner counters"}},
]
...
FAQS = [
    {
        "q": {"hi": "बुकिंग के लिए कितना एडवांस देना होता है?", "en": "How much advance is needed to book?"},
        "a": {"hi": "तारीख होल्ड करने के लिए 25%। बाकी रकम कार्यक्रम से 7 दिन पहले। रसीद उसी दिन मिलती है।", "en": "25% to hold the date. The balance 7 days before the event. Receipt issued the same day."},
    },
    {
        "q": {"hi": "क्या बाहर का कैटरर ला सकते हैं?", "en": "Can we bring an outside caterer?"},
        "a": {"hi": "हाँ, ₹300 प्रति प्लेट रॉयल्टी पर। किचन और गैस हमारा रहेगा।", "en": "Yes, at ₹300 per plate royalty. Kitchen and gas stay ours."},
    },
    {
        "q": {"hi": "तारीख बदलनी पड़े तो?", "en": "What if we need to change the date?"},
        "a": {"hi": "कार्यक्रम से 60 दिन पहले तक एक बार तारीख बदल सकते हैं, बिना किसी शुल्क के — उपलब्धता के अनुसार।", "en": "One free date change up to 60 days before the event, subject to availability."},
    },
    {
        "q": {"hi": "साउंड कितने बजे तक चल सकता है?", "en": "Till what time is sound allowed?"},
        "a": {"hi": "खुले लॉन में रात 10 बजे तक, एसी हॉल में रात 12 बजे तक — प्रशासन के नियम के अनुसार।", "en": "Till 10 PM on the open lawn, till 12 AM in the AC hall, as per local rules."},
    },
]

# ---- Date availability ----------------------------------------------------
# Deterministic demo calendar. Real build mein yeh bookings table se aayega.

_BOOKED_OFFSETS = {3, 11, 12, 19, 27, 34, 41, 42, 55, 63, 70, 84, 96, 110, 121, 133, 148, 160}
_TENTATIVE_OFFSETS = {7, 22, 31, 48, 59, 77, 90, 105, 128, 141, 155}

# Demo muhurat dates (auspicious). Real build: panchang feed se.
_MUHURAT_MMDD = {
    (8, 19), (8, 23), (8, 27),
...
def day_status(d: date) -> str:
    """available | tentative | booked | past"""
    today = date.today()
    if d < today:
        return "past"
    offset = (d - _ANCHOR).days
    if offset % 173 in _BOOKED_OFFSETS or offset % 91 in _BOOKED_OFFSETS:
        return "booked"
    if offset % 173 in _TENTATIVE_OFFSETS:
        return "tentative"
    return "available"


def is_muhurat(d: date) -> bool:
    return (d.month, d.day) in _MUHURAT_MMDD


def month_availability(year: int, month: int):
        ...
        days.append(
            {
                ...
                "status": day_status(cur),
                "muhurat": is_muhurat(cur),
            }
        )
...
# Enquiries: process memory mein. Server restart pe khali. Demo hai.
ENQUIRIES = []
